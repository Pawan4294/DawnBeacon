...
// Nominatim rate limiter — max 1 req/second per policy
...
async function queryOverpass(lat: number, lng: number): Promise<OverpassData | null> {
  // Query for buildings and POIs within 500m radius
  const overpassQuery = `
    [out:json][timeout:15];
    (
...
function inferDensity(overpass: OverpassData | null): "few" | "moderate" | "a lot" {
