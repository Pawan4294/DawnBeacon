          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-1.5 px-3 sm:px-5 py-4 text-sm font-medium whitespace-nowrap transition-all duration-200 border-b-2 flex-shrink-0
                  ${isActive
